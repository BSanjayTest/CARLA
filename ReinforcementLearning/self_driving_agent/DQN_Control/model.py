...
class DQN(object):
    def __init__(
        ...
        discount=0.9,
        optimizer="Adam",
        optimizer_parameters={'lr':0.001},  # Lower learning rate for stability
        target_update_frequency=1000,  # Update target network more frequently
        initial_eps = 1,
        end_eps = 0.05,
        eps_decay_period = 10000,  # Faster epsilon decay
        eval_eps=0.001
    ) -> None:
        self.device = device
